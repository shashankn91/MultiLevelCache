...
@NoArgsConstructor
public class WriteTimeMetrics implements IMetricsGenerator{
    ...
    public void addLogs(MultiLevelCacheResponse multiLevelCacheResponse) {
        if(multiLevelCacheResponse.getOperationType() == OperationType.READ){
            return;
        }
    ...
    public String getMetrics() {
        ...
        return "WriteTimeMetrics totalTime = " + totalTime.toString()+ "\n";
    }
